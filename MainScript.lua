...
local function eulerToQuaternion(roll, pitch, yaw) -- Converts euler rotations to a quaternion.
	if roll == nil then
		roll = 0
	end
	if pitch == nil then
...
-- Setup
local matList = { Enum.Material.Ice, Enum.Material.Brick, Enum.Material.Wood, Enum.Material.WoodPlanks, Enum.Material.ForceField, Enum.Material.Slate, Enum.Material.Pebble, Enum.Material.Foil }
local matListCoor = { 2, 0, 4, 4, 3, 1, 1, 9 }

local headscale = 0.3

local children = workspace.GrabMap:GetDescendants()
